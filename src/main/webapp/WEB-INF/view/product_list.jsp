...
<div id="wrap" >
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table  id="dataTables-example">
                                        ...
                                        <c:forEach items="${products}" var="temp">
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a
                                                        href="/product/getUpdateData?id=<c:out value="${temp.id}"/>"
                                    ...
                                    <div class="panel-heading"><a
                                            href="/product/insertPage"><button style="margin-top: -9%;"
    ...
    <script>
        ...
        function changeStatus(id,action) {
            ...
            var url;
            if(action=='ACTIVE'){
                url = "/product/activate?id="+id;
            }else{

                url = "/product/deactivate?id="+id;
            }
