    ...
    <div id="content">
        ...
        <div class="inner" style="min-height: 700px;">
            <ul class="breadcrumb" style="margin-top:2%;">
                ...
                <li><a href="/exercise/insertPage">Add Exercise</a></li>
            </ul>
            <div class="row">
                        ...
                        <form id="exerciseForm" class="form-horizontal" align="center"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <label class="control-label col-md-5" style="float: right;"> Exercise ID</label>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" id="exerciseId" name="id"
                                               readonly="readonly" class="form-control"
                                               value="<c:out value="${exercise.id}" />"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="name" name="name"
                                               placeholder="Enter Exercise Name" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="ACTIVE" <c:if test="${exercise.status == 'ACTIVE'}"> <c:out
                                                    value="selected=selected"/></c:if>>ACTIVE
                                            </option>
                                            <option value="DEACTIVE" <c:if test="${exercise.status == 'DEACTIVE'}">
        ...
        $("#exerciseForm").submit(
            function (e) {
                ...
                if (!$("#exerciseForm").valid())
                    return false;
                var formData = getFormDataAsDTO("exerciseForm");
                $.ajax({
                    type: "POST",
                    url: "/exercise/save",
                    dataType: 'json',
