...
<div id="wrap" >
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table  id="dataTables-example">
                                        ...
                                        <c:forEach items="${subjects}" var="temp">
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a
                                                        href="/subject/getUpdateData?id=<c:out value="${temp.id}"/>"
                                    ...
                                    <div class="panel-heading"><a
                                            href="/subject/insertPage"><button style="margin-top: -9%;"
    ...
    <script>
        ...
        function changeStatus(id,action) {
            ...
            var url;
            if(action=='ACTIVE'){
                url = "/subject/activateSubject?id="+id;
            }else{

                url = "/subject/deactivateSubject?id="+id;
            }
