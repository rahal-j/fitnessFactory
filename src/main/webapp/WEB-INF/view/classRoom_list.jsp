...
<div id="wrap">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="dataTables-example">
                                        ...
                                        <c:forEach items="${rooms}" var="temp">
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a
                                                        href="/class/getUpdateData?id=<c:out value="${temp.id}"/>"
                                    ...
                                    <div class="panel-heading"><a
                                            href="/class/insertPage">
                                        <button style="margin-top: -9%;"
                                                class="btn-sm btn-primary">Add New
                                        </button>
                                    </a>
                                    </div>
    ...
    <script>
        ...
        function changeStatus(id,action) {
            ...
            var url;
            if(action=='ACTIVE'){
                url = "/class/activateClassRoom?id="+id;
            }else{

                url = "/class/deactivateClassRoom?id="+id;
            }
