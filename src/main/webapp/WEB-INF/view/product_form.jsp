                        ...
                        <form id="productForm" class="form-horizontal" align="center"
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="title" id="isExpire" class="form-control">
                                            <option value="">Is Expire</option>
                                            <option value="1" <c:if test="${product.title == '1'}"> <c:out value= "selected=selected"/></c:if>>Yes</option>
                                            <option value="0" <c:if test="${product.title == '0'}"> <c:out value= "selected=selected"/></c:if>>No</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
