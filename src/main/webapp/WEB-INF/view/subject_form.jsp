    ...
    <div id="content">
        ...
        <div class="inner" style="min-height: 700px;">
            <ul class="breadcrumb" style="margin-top:2%;">
                ...
                <li><a href="/subject/insertPage">Add Subject</a></li>
            </ul>
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="box dark">
                        ...
                        <form id="subjectForm" class="form-horizontal" align="center"
                              novalidate>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <label class="control-label col-md-5" style="float: right;"> Subject ID</label>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="ACTIVE" <c:if test="${subject.status == 'ACTIVE'}"> <c:out value= "selected=selected"/></c:if>>ACTIVE</option>
                                            <option value="DEACTIVE" <c:if test="${subject.status == 'DEACTIVE'}"> <c:out value= "selected=selected"/></c:if>>DEACTIVE</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
        ...
        $("#subjectForm").submit(
            function (e) {
                ...
                if (!$("#subjectForm").valid())
                    return false;
                var formData = getFormDataAsDTO("subjectForm");
                $.ajax({
                    type: "POST",
