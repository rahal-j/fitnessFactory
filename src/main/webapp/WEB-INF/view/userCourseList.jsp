                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table  id="dataTables-example">
                                        ...
                                        <tbody>
                                        <c:forEach items="${userCourse}" var="temp">
                                            <tr class="odd gradeX">
                                                <td><c:out value="${temp.id}"/></td>
                                                <td><c:out value="${temp.firstName}"/></td>
                                                <td><c:out value="${temp.lastName}"/></td>
                                                <td><c:out value="${temp.nic}"/></td>
                                                <td><c:out value="${temp.course}"/></td>
                                                <td align="left">
                                                ...
                                                <td><a
                                                        href="/userCourse/getUpdateData?id=<c:out value="${temp.id}"/>"
...
<%--
                                    ...
                                    <div class="panel-heading"><a
                                            href="/userCourse/insertPage"><button style="margin-top: -9%;"
    ...
    <script>
        ...
        function changeStatus(id,action) {
            ...
            var url;
            if(action=='ACTIVE'){
                url = "/userCourse/activateUser?id="+id;
            }else{

                url = "/userCourse/deactivateUser?id="+id;
            }
