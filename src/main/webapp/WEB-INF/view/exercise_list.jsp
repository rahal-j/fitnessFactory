...
<div id="wrap" >
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table  id="dataTables-example">
                                        ...
                                        <c:forEach items="${exercises}" var="temp">
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a
                                                        href="/exercise/getUpdateData?id=<c:out value="${temp.id}"/>"
                                    ...
                                    <div class="panel-heading"><a
                                            href="/exercise/insertPage"><button style="margin-top: -9%;"
    ...
    <script>
        ...
        function changeStatus(id,action) {
            ...
            var url;
            if(action=='ACTIVE'){
                url = "/exercise/activate?id="+id;
            }else{

                url = "/exercise/deactivate?id="+id;
            }
