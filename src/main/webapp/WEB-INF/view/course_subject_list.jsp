...
<head>
    <meta charset="UTF-8" />
    <title>Add Subjects to Course </title>
...
<div id="wrap" >
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table  id="dataTables-example">
                                        ...
                                        <c:forEach items="${courses}" var="temp">
                                            <tr class="odd gradeX">
                                                ...
                                                <td><c:out value="${temp.startDate}"/></td>
                                                ...
                                                <td><a
                                                        href="/courseSubject/getUpdateData?id=<c:out value="${temp.id}"/>"
                                    ...
                                    <div class="panel-heading"><a
                                            href="/courseSubject/insertPage"><button style="margin-top: -9%;"
    ...
    <script>
        ...
        function changeStatus(id,action) {
            ...
            var url;
            if(action=='ACTIVE'){
                url = "/course/activateCourse?id="+id;
            }else{

                url = "/course/deactivateCourse?id="+id;
            }
