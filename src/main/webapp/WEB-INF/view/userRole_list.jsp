...
<div id="wrap" >
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table  id="dataTables-example">
                                        ...
                                        <tbody>
                                        <c:forEach items="${userRole}" var="temp">
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a
                                                        href="/userRole/getUpdateData?id=<c:out value="${temp.id}"/>"
                                    ...
                                    <div class="panel-heading"><a
                                            href="/userRole/insertPage"><button style="margin-top: -9%;"
    ...
    <script>
        ...
        function changeStatus(id,action) {
            ...
            var url;
            if(action=='ACTIVE'){
                url = "/userRole/activateUserRole?id="+id;
            }else{

                url = "/userRole/deactivateUserRole?id="+id;
            }
